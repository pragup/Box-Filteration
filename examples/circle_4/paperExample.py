...
data_ = pd.read_csv('data/neighboringCircles2.csv', header= None)
...
fileName_ = "output/2dBinDataPlot_filter_1_alpha_"+ str(expansionRate_)+".pdf"
pc.draw2DPartition(binning_.getCover(), 1, fileName_, 2, "b", "or")

fileName_ = "output/2dBinDataPlot_filter_2_alpha_"+ str(expansionRate_)+".pdf"
pc.draw2DPartition(binning_.getCover(), 2, fileName_, 2, "b", "or")

fileName_ = "output/2dBinDataPlot_filter_3_alpha_"+ str(expansionRate_)+".pdf"
pc.draw2DPartition(binning_.getCover(), 3, fileName_, 2, "b", "or")

fileName_ = "output/2dBinDataPlot_filter_4_alpha_"+ str(expansionRate_)+".pdf"
pc.draw2DPartition(binning_.getCover(), 4, fileName_, 2, "b", "or")

...
data_ = np.genfromtxt('data/flam-reference.csv', delimiter=',')
...
clusteringAlgo__ = sc.KMeans(init="k-means++", n_clusters=25, n_init=4, random_state=0).fit(dataPoints_)
# clusteringAlgo__ = sc.DBSCAN(eps=3, min_samples=5)
...
# fileName_ = "output/plots/2dDataPoints.pdf"
# pc.draw2DPoints(dataPoints_, fileName_, 1, "or")
#
# fileName_ = "output/plots/2dBinDataPlot_filter_8.pdf"
# pc.draw2DPartition(binning_.getCover(), 8, fileName_, 2, "b", "or")
#
# fileName_ = "output/plots/2dBinDataPlot_filter_16.pdf"
# pc.draw2DPartition(binning_.getCover(), 16, fileName_, 2, "b", "or")
#
# fileName_ = "output/plots/2dBinDataPlot_filter_20.pdf"
# pc.draw2DPartition(binning_.getCover(), 20, fileName_, 2, "b", "or")
#
# fileName_ = "output/plots/2dBinDataPlot_filter_25.pdf"
# pc.draw2DPartition(binning_.getCover(), 25, fileName_, 2, "b", "or")

# diag = weightedFilteredComplex_.getComplex().persistence(min_persistence=0.4)
